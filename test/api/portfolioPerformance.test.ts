import { calculatePortfolioPerformance, PortfolioPerformance, calculateCompoundInterest, calculateInvestmentGrowth } from '../../src/Portfolio/portfolioPerformance';
...
describe('calculatePortfolioPerformance', () => {
  ...
  it('should handle large losses and reflect the significant loss summary', () => {
    const result = calculatePortfolioPerformance(10000, 4000);
...
it('should correctly calculate compound interest', () => {
  const result = calculateCompoundInterest(1000, 5, 5, 1);  // Principal, Rate, Time, Frequency (1 = annually)
...
it('should calculate compound interest with annual compounding', () => {
  const result = calculateCompoundInterest(1500, 3, 3, 1);
...
describe('calculateInvestmentGrowth', () => {
  it('should correctly calculate investment growth over time', () => {
    const result = calculateInvestmentGrowth(1000, 0.05, 5);  // Principal, Rate, Time
  ...
  it('should calculate investment growth with higher growth rate', () => {
    const result = calculateInvestmentGrowth(2000, 0.08, 10);  // Principal, Growth rate, Years
